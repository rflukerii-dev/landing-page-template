...
const PricingColumn: React.FC<Props> = ({ tier, highlight }: Props) => {
    ...
    return (
        <div className={clsx("w-full max-w-sm mx-auto bg-[#050a02] rounded-xl lg:max-w-full", { "shadow-lg": highlight })}>
            <div className="p-6 rounded-t-xl">
                ...
                <p className="text-3xl md:text-5xl font-bold mb-6">
                    ...
                    {typeof price === 'number' && <span className="text-lg font-normal text-white">/mo</span>}
                </p>
